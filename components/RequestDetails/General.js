    ...
    return (
        <div className={clsx(classes.root, className)} {...rest} style={{ width: '100%' }}>
            <Grid container spacing={isMd ? 4 : 2}>
                ...
                {
                    !request?.hasDutchNationality && request.images?.find(img => img.categoryId === 1) ?
                        <Grid item xs={12}>
                            <Typography variant="h6" color="textPrimary">Pèrmit di estadia</Typography>
                            <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                {request.images ?
                                    request.images.filter(img => img.categoryId === 1).map((image, index) => (
                                                ...
                                                image.type.includes('application/pdf') ?
                                                    ...
                                                    <div style={{ height: 500, position: 'relative' }} >
                                                        ...
                                                        <ImageListItemBar
                                                            title={image.name}
                                                            actionIcon={
                                                                <IconButton aria-label={`info about ${image.name}`}>
                                                                    <InfoIcon />
                                                                </IconButton>
                                                            }
                                                        />
                ...
                </Grid>
                {
                    request.images?.find(img => img.categoryId === 22) ?
                        <Grid item xs={12}>
                            <Typography variant="h6" color="textPrimary">Prueba di bo identifikashon</Typography>
                            <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                {request.images ?
                                    request.images.filter(img => img.categoryId === 22).map((image, index) => (
                                        <ImageListItem key={index} className={classes.gridListTile}>
                                            {
                                                image.type.includes('application/pdf') ?
                                                    <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="580px"></iframe> :
                ...
                {['divorced', 'divorcedPartnership'].includes(request?.maritalStatus) &&
                    <>
                        <Grid item xs={12}>
                            <Typography variant="h6" color="textPrimary">prueba di divorsio {request?.maritalStatus === 'divorcedPartnership' ?? 'di konbibensia legalisá di pareha'}</Typography>
                            <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                {request.images ?
                                    request.images.filter(img => img.categoryId === 5).map((image, index) => (
                                        <ImageListItem key={index} className={classes.gridListTile}>
                                            {
                                                image.type.includes('application/pdf') ?
                        ...
                        <Grid item xs={12}>
                            <Typography variant="h6" color="textPrimary">prueba di veredikto</Typography>
                            <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                {request.images ?
                                    request.images.filter(img => img.categoryId === 21).map((image, index) => (
                                        <ImageListItem key={index} className={classes.gridListTile}>
                                            {
                                                image.type.includes('application/pdf') ?
                                                    <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe>
                ...
                {(request.maritalStatus === 'divorced' || request.maritalStatus === 'single') &&
                    <Grid item xs={12}>
                        <Typography
                            variant="subtitle1"
                            color="textPrimary"
                ...
                {
                    ['married', 'registeredPartnership', 'widow', 'divorcedPartnership'].includes(request?.maritalStatus) || request?.hasRelationship ?
                        <>
                            <Grid item xs={12} sm={6}>
                                <Typography
                                    variant="subtitle1"
                                    ...
                                    className={classes.inputTitle}
                                >
                                    Fam di {request?.maritalStatus === "married" ? "kasá" : request?.maritalStatus === "widow" ? "kasá ku a fayesé" : "pareha"}
                                </Typography>
                                <Typography
                                    variant="subtitle1"
                                    color="textPrimary"
                            ...
                            <Grid item xs={12} sm={6}>
                                <Typography
                                    ...
                                    className={classes.inputTitle}
                                >
                                    Nòmber di {request?.maritalStatus === "married" ? "kasá" : request?.maritalStatus === "widow" ? "kasá ku a fayesé" : "pareha"}
                                </Typography>
                                <Typography
                                    variant="subtitle1"
                                    color="textPrimary"
                            ...
                            <Grid item xs={12} sm={6}>
                                <Typography
                                    ...
                                    className={classes.inputTitle}
                                >
                                    Number di identifikashon riba sédula di {request?.maritalStatus === "married" ? "kasá" : request?.maritalStatus === "widow" ? "kasá ku a fayesé" : "pareha"}
                                </Typography>
                                <Typography
                                    variant="subtitle1"
                                    color="textPrimary"
                            ...
                            {
                                ['married', 'registeredPartnership', 'single', 'divorced'].includes(request?.maritalStatus) &&
                                <Grid item xs={12}>
                                    <Typography
                                        variant="subtitle1"
                                        color="textPrimary"
                                        className={classes.inputTitle}
                                    >
                                        Prueba di entrada di bo {request?.maritalStatus === "married" ? 'kasá' : 'pareha'}
                                    </Typography>
                                    <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                        {request.images ?
                                            request.images.filter(img => img.categoryId === 2).map((image, index) => (
                                                <ImageListItem key={index} className={classes.gridListTile}>
                                                    {
                                                        image.type.includes('application/pdf') ?
                                                            <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                            ...
                            {request?.maritalStatus === 'widow' &&
                                <Grid item xs={12} sm={6}>
                                    ...
                                    <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                        {request.images ?
                                            request.images.filter(img => img.categoryId === 6).map((image, index) => (
                                                <ImageListItem key={index} className={classes.gridListTile}>
                                                    {
                                                        image.type.includes('application/pdf') ?
                                                            <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                    ...
                    request?.hasChildren ?
                        <>
                            ...
                            <Grid item xs={12}>
                                ...
                                <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                    {request.images ?
                                        request.images.filter(img => img.categoryId === 7).map((image, index) => (
                                            <ImageListItem key={index} className={classes.gridListTile}>
                                                {
                                                    image.type.includes('application/pdf') ?
                                                        <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                    ...
                    <>
                        <Grid item xs={12}>
                            ...
                            >
                                ...
                                {request?.work === 'selfEmployed' && 'Mi ta traha riba mi mes (lora man)'}
                            </Typography>
                        </Grid>
                        {
                            ...
                            <>
                                ...
                                {
                                    (['company', 'person'].includes(request?.contractee) || request?.work === 'employee') &&
                                    <>
                                        {
                                            (request?.contractee === 'company' || request?.work === 'employee') ?
                                                <Grid item xs={12} sm={6}>
                                                    <Typography
                                                        variant="subtitle1"
                                                        color="textPrimary"
                        ...
                        {
                            ['freelance', 'employee', 'selfEmployed'].includes(request?.work) &&
                            <>
                                <Grid item xs={12} sm={6}>
                                    <Typography
                                        variant="subtitle1"
                                        ...
                                        className={classes.inputTitle}
                                    >
                                        {`Ki tipo di ${request?.work === 'freelance' ? 'djòp bo ta kue' : 'trabou bo ta hasi'}?`}
                                    </Typography>
                                    <Typography
                                        variant="body1"
                                        color="textSecondary"
                                    ...
                                    <>
                                        ...
                                        </Grid>
                                        {
                                            ...
                                            <Grid item xs={12} sm={6}>
                                                ...
                                                <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                                    {request.images ?
                                                        request.images.filter(img => img.categoryId === 20).map((image, index) => (
                                                            <ImageListItem key={index} className={classes.gridListTile}>
                                                                {
                                                                    image.type.includes('application/pdf') ?
                                                                        <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                    ...
                    request.reason === 'lostJob' ?
                                ...
                                ['person', 'company'].includes(request.lastWork) ?
                                    <>
                                        ...
                                        <Grid item xs={12}>
                                            ...
                                            <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                                {request.images ?
                                                    request.images.filter(img => img.categoryId === 15).map((image, index) => (
                                                        <ImageListItem key={index} className={classes.gridListTile}>
                                                            {
                                                                image.type.includes('application/pdf') ?
                                                                    <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                        ...
                        <>
                            ...
                            <Grid item xs={12} sm={6}>
                                ...
                                <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                    {request.images ?
                                        request.images.filter(img => img.categoryId === 9).map((image, index) => (
                                            <ImageListItem key={index} className={classes.gridListTile}>
                                                {
                                                    image.type.includes('application/pdf') ?
                                                        <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                    ...
                    request.activelyJobSeeking ?
                        <>
                            ...
                            <Grid item xs={12}>
                                ...
                                <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                    {request.images ?
                                        request.images.filter(img => img.categoryId === 8).map((image, index) => (
                                            <ImageListItem key={index} className={classes.gridListTile}>
                                                {
                                                    image.type.includes('application/pdf') ?
                                                        <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                ...
                {
                    (request?.bankAccountType === 'current' || request?.bankAccountType === 'both') &&
                    <Grid item xs={12} sm={(request?.bankAccountType === 'savings' || request?.bankAccountType === 'both') ? 6 : false}>
                        <Typography
                            variant="subtitle1"
                            color="textPrimary"
                            className={classes.inputTitle}
                        ...
                        <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                            {request.images ?
                                request.images.filter(img => img.categoryId === 10).map((image, index) => (
                                    <ImageListItem key={index} className={classes.gridListTile}>
                                        {
                                            image.type.includes('application/pdf') ?
                                                <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                ...
                {
                    (request.bankAccountType === 'savings' || request.bankAccountType === 'both') &&
                    <Grid item xs={12} sm={6}>
                        <Typography
                            variant="subtitle1"
                            color="textPrimary"
                        ...
                        <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                            {request.images ?
                                request.images.filter(img => img.categoryId === 11).map((image, index) => (
                                    <ImageListItem key={index} className={classes.gridListTile}>
                                        {
                                            image.type.includes('application/pdf') ?
                                                <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                ...
                </Grid>
                {
                    ...
                    <>
                        ...
                        {
                            (request?.hasOwnHouse || (!request?.hasOwnHouse && request?.notOwnHouse !== '')) &&
                            <>
                                <Grid item xs={12} sm={6}>
                                    <Typography
                                        variant="subtitle1"
                                ...
                                }
                                {
                                    request?.hasOwnHouse ?
                                        <>
                                            ...
                                            {
                                                request?.payingMortgage !== null && !request?.payingMortgage &&
                                                <Grid item xs={12} sm={6}>
                                                    <Typography
                                                        variant="subtitle1"
                                                        color="textPrimary"
                                ...
                                }
                                {
                                    ...
                                    <>
                                        <Grid item xs={12}>
                                            ...
                                            <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                                {request.images ?
                                                    request.images.filter(img => img.categoryId === 16).map((image, index) => (
                                                        <ImageListItem key={index} className={classes.gridListTile}>
                                                            {
                                                                image.type.includes('application/pdf') ?
                                                                    <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                                        ...
                                        </Grid>
                                        {
                                            ...
                                            <Grid item xs={12}>
                                                ...
                                                <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                                    {request.images ?
                                                        request.images.filter(img => img.categoryId === 17).map((image, index) => (
                ...
                }
                {
                    ...
                    <Grid item xs={12}>
                        ...
                        <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                            {request.images ?
                                request.images.filter(img => img.categoryId === 12).map((image, index) => (
                                    <ImageListItem key={index} className={classes.gridListTile}>
                                        {
                                            image.type.includes('application/pdf') ?
                                                <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                ...
                }
                {
                    ...
                    <Grid item xs={12}>
                        ...
                        <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                            {request.images ?
                                request.images.filter(img => img.categoryId === 13).map((image, index) => (
                                    <ImageListItem key={index} className={classes.gridListTile}>
                                        {
                                            image.type.includes('application/pdf') ?
                                                <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                    ...
                    <Grid item xs={12}>
                        ...
                        <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                            {request.images ?
                                request.images.filter(img => img.categoryId === 14).map((image, index) => (
                                    <ImageListItem key={index} className={classes.gridListTile}>
                                        {
                                            image.type.includes('application/pdf') ?
                                                <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                ...
                </Grid>
                {
                    ...
                    <Grid item xs={12} sm={request.hasPsychologicalLimitationTreatment ? 6 : false}>
                        <Typography
                            variant="subtitle1"
                            color="textPrimary"
                            className={classes.inputTitle}
                ...
                }
                {
                    request.hasPsychologicalLimitationDiagnostic ?
                        <>
                            ...
                            <Grid item xs={12} sm={request.hasPsychologicalLimitationDiagnosticReport ? 6 : false}>
                                <Typography
                                    variant="subtitle1"
                                    color="textPrimary"
                                    className={classes.inputTitle}
                                ...
                                <Typography
                                    ...
                                    color="textSecondary"
                                >
                                    {request?.hasPsychologicalLimitationDiagnosticReport ? 'Si' : 'Nò'}
                                </Typography>
                            </Grid>
                            {
                                ...
                                <Grid item xs={12} sm={6}>
                                    ...
                                    <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                        {request.images ?
                                            request.images.filter(img => img.categoryId === 18).map((image, index) => (
                                                <ImageListItem key={index} className={classes.gridListTile}>
                                                    {
                                                        image.type.includes('application/pdf') ?
                                                            <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
                ...
                </Grid>
                {
                    ...
                    <Grid item xs={12} sm={request.hasMentalDisorderTreatment ? 6 : false}>
                        <Typography
                            variant="subtitle1"
                            color="textPrimary"
                            className={classes.inputTitle}
                ...
                }
                {
                    request.hasMentalDisorderDiagnostic ?
                        <>
                            ...
                            <Grid item xs={12} sm={request.hasMentalDisorderDiagnosticReport ? 6 : false}>
                                <Typography
                                    variant="subtitle1"
                                    color="textPrimary"
                                    className={classes.inputTitle}
                            ...
                            </Grid>
                            {
                                ...
                                <Grid item xs={12} sm={6}>
                                    ...
                                    <ImageList className={classes.gridList} rowHeight={'auto'} cols={0}>
                                        {request.images ?
                                            request.images.filter(img => img.categoryId === 19).map((image, index) => (
                                                <ImageListItem key={index} className={classes.gridListTile}>
                                                    {
                                                        image.type.includes('application/pdf') ?
                                                            <iframe title={image.name} src={`${image.type},${image.base64}`} width="100%" height="500px"></iframe> :
