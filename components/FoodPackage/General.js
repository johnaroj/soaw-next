...
const General = (props) => {
  ...
  const [mutateRequest, { isLoading, isSuccess, isError, error }] = useMutation(
    async (data) => {
  ...
  return isLoading || isExisitsLoading ? (
      ...
      <Grid container spacing={isMd ? 4 : 2}>
        ...
        <Grid item xs={12} sm={6}>
          ...
          >
            ...
            {watch("identificationType") === "driversLicense"
              ? "reibeweis"
              : "sédula"}
          </Typography>
          <Controller
          ...
          <>
            <Grid item xs={12} sm={6}>
              ...
              >
                ...
                {watch("maritalStatus")?.value === "divorcedPartnership" &&
        ...
        {watch("maritalStatus")?.value === "divorced" ||
        ...
        {[
          ...
          "widow",
          "divorcedPartnership",
        ].includes(watch("maritalStatus")?.value) ||
        JSON.parse(watch("hasRelationship")) ? (
          <>
            <Grid item xs={12} sm={6}>
              ...
              >
                Fam di{" "}
                {watch("maritalStatus")?.value === "married"
                  ? "kasá"
            ...
            {["registeredPartnership", "married"].includes(
              watch("maritalStatus")?.value
            ) && (
              <Grid item xs={12} sm={6}>
                <Typography
                  ...
                  render={({ field }) => (
                    <DropzoneArea
                      ...
                      onDrop={(files) =>
                        onDropHandler(
                          files,
                          watch("maritalStatus")?.value === "married" ? 3 : 4
                        )
                      }
                      onDelete={(file) =>
                        onDeleteHandler(
