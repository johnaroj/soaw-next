...
const HealthForm = (props) => {
  ...
  const schema = yup.object().shape({
    ...
    hasAdiction: yup
      .bool()
      .nullable()
      .required("Mester skohe si bo ta sufri di un òf mas adikshon"),
    hasAdictionTreatment: yup
      .bool()
      .nullable()
      .when("hasAdiction", {
        is: (val) => val && val === true,
        then: yup
          .bool()
          .nullable()
          .required("Mester skohe si Bo ta hañando yudansa di un instansia"),
      }),
    ...
    hasDiseases: yup
      .bool()
      .nullable()
      .required("Mester skohe si bo ta sufri di algun malesa"),
    ...
    hasPsychologicalLimitation: yup
      .bool()
      .nullable()
      .required("Mester skohe si bo tin problema sígiko"),
    hasPsychologicalLimitationTreatment: yup
      .bool()
      .nullable()
      .when("hasPsychologicalLimitation", {
        is: (val) => val && val === true,
        then: yup
          .bool()
          .nullable()
          .required("Mester skohe si bo ta haña yudansa di un instansia"),
      }),
    psychologicalLimitationCenter: yup
      .string()
      .when("hasPsychologicalLimitationTreatment", {
        is: (val) => val && val === true,
        then: yup.string().nullable().required("Mester indiká kua instansia"),
      }),
    hasPsychologicalLimitationDiagnostic: yup
      .bool()
      .nullable()
      .when("hasPsychologicalLimitation", {
        is: (val) => val && val === true,
        then: yup
          .bool()
          .nullable()
          .required("Mester skohe si tin un diagnóstiko?"),
      }),
    psychologicalLimitationDiagnostician: yup
      .string()
      .when("hasPsychologicalLimitationDiagnostic", {
        is: (val) => val && val === true,
        then: yup.string().required("Mester yena ken a hasi e diagnóstiko aki"),
      }),
    psychologicalLimitationDiagnosticDate: yup
      .string()
      .nullable()
      .when("hasPsychologicalLimitationDiagnostic", {
        is: (val) => val,
    ...
    hasPsychologicalLimitationDiagnosticReport: yup
      .bool()
      .nullable()
      .when("hasPsychologicalLimitationDiagnostic", {
        is: (val) => val && val === true,
        then: yup
          .bool()
          .nullable()
          .required("Mester yena si tin un rapòrt di e diagnóstiko"),
      }),
    proofOfPsychologicalLimitationDiagnosticReport: yup
      .array()
      .when("hasPsychologicalLimitationDiagnosticReport", {
        is: (val) => val && val === true,
        then: yup
          .array()
          .required("Mester ‘upload’ karta di diagnóstiko di bo médiko"),
      }),
    hasMentalDisorder: yup
      .bool()
      .nullable()
      .required("Mester skohe si bo tin retardashon mental"),
    hasMentalDisorderTreatment: yup
      .bool()
      .nullable()
      .when("hasMentalDisorder", {
        is: (val) => val && val === true,
        then: yup
          .bool()
          .nullable()
    ...
    mentalDisorderTreatmentCenter: yup
      .string()
      .when("hasMentalDisorderTreatment", {
        is: (val) => val && val === true,
        then: yup.string().required("Mester indiká kua instansia?"),
      }),
    hasMentalDisorderDiagnostic: yup
      .bool()
      .nullable()
      .when("hasMentalDisorder", {
        is: (val) => val && val === true,
    ...
    mentalDisorderDiagnostician: yup
      .string()
      .when("hasMentalDisorderDiagnostic", {
        is: (val) => val && val === true,
        then: yup.string().required("Mester yena ken a hasi e diagnóstiko aki"),
      }),
    mentalDisorderDiagnosticDate: yup
      .string()
      .nullable()
      .when("hasMentalDisorderDiagnostic", {
        is: (val) => val && val === true,
    ...
    hasMentalDisorderDiagnosticReport: yup
      .bool()
      .nullable()
      .when("hasMentalDisorderDiagnostic", {
        is: (val) => val && val === true,
    ...
    proofOfMentalDisorderDiagnosticReport: yup
      .array()
      .when("hasMentalDisorderDiagnosticReport", {
        is: (val) => val && val === true,
        then: yup
          .array()
          .required("Mester ‘upload’ karta di diagnóstiko di bo médiko"),
      }),
    hasPsychologicalLimitationChild: yup
      .bool()
      .nullable()
      .required("Mester skohe si bo tin yu ku limitashon mental"),
    insurance: yup.string().required("Mester skohe tipo di seguro bo tin"),
    hasMedicalTreatment: yup
      .bool()
      .nullable()
      .required(
        "Mester skohe si bo ta bou di tratamentu di un médiko òf paramédiko"
      ),
    medicalTreatment: yup.string().when("hasMedicalTreatment", {
      is: (val) => val && val === true,
      then: yup
        .string()
        .required("Mester skohe ki tipo di médiko òf paramédiko"),
    }),
    medicalPractitionerName: yup.string().when("hasMedicalTreatment", {
      is: (val) => val === true,
      then: yup
        .string()
        .required("Mester yena nomber di médiko òf paramédiko?"),
    }),
    proofOfMedicalTreatment: yup.array().when("medicalTreatment", {
      is: (val) =>
        val &&
        ["specialist", "psychologist", "psychiatrist"].includes(
          watch("medicalTreatment")
        ),
      then: yup.array().required("Mester ‘upload’ e karta di bo spesialista"),
    }),
    useMedicalSupplies: yup
      .bool()
      .nullable()
      .required("Mester skohe si bo ta usa medikamentu"),
    ...
    hasWelfare: yup
      ...
      .nullable()
      .required(
        "Mester skohe si bo ta risibí yudansa sosial pa motibu di bo estado di salú"
      ),
    welfare: yup.string().when("hasWelfare", {
      is: (val) => val === true,
      then: yup.string().required("Mester yena ki tipo di yudansa"),
    }),
    hasFuneralInsurance: yup
      .bool()
      .nullable()
      .required("Mester skohe si bo tin seguro di entiero"),
  ...
  const onDeleteHandler = (file, category) => {
    setImages(
      images.filter(
        (image) => image.name !== file.name && image.category !== category
      )
    );
  };
    ...
    <div className={clsx(classes.root, className)} {...rest}>
      <Grid container spacing={isMd ? 4 : 2}>
        ...
        <Grid item xs={12} sm={6}>
          ...
          />
          {errors.mobility && (
            <p style={{ color: "#bf1650" }}>{errors.mobility.message}</p>
          )}
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography
          ...
          />
          {errors.hearing && (
            <p style={{ color: "#bf1650" }}>{errors.hearing.message}</p>
          )}
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography
          ...
          />
          {errors.visibility && (
            <p style={{ color: "#bf1650" }}>{errors.visibility.message}</p>
          )}
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography
          ...
          />
          {errors.speakingAbility && (
            <p style={{ color: "#bf1650" }}>{errors.speakingAbility.message}</p>
          )}
        </Grid>
        <Grid
          item
          xs={12}
          sm={
            JSON.parse(watch("hasAdiction") ?? request.hasAdiction) ? 6 : false
          }
        >
          <Typography
            variant="subtitle1"
          ...
          />
          {errors.hasAdiction && (
            <p style={{ color: "#bf1650" }}>{errors.hasAdiction.message}</p>
          )}
        </Grid>
        {JSON.parse(watch("hasAdiction") ?? request.hasAdiction) ? (
          ...
          >
            ...
            />
            {errors.hasAdictionTreatment && (
              <p style={{ color: "#bf1650" }}>
                {errors.hasAdictionTreatment.message}
              </p>
            )}
          </Grid>
        ) : null}
        {JSON.parse(
          watch("hasAdictionTreatment") ?? !!request.hasAdictionTreatment
        ) ? (
          <Grid item xs={6} sm={3}>
            <Typography
              variant="subtitle1"
            ...
            />
            {errors.adictionTreatmentCenter && (
              <p style={{ color: "#bf1650" }}>
                {errors.adictionTreatmentCenter.message}
              </p>
            )}
          </Grid>
        ) : null}
        ...
        >
          ...
          />
          {errors.hasDiseases && (
            <p style={{ color: "#bf1650" }}>{errors.hasDiseases.message}</p>
          )}
        </Grid>
        {JSON.parse(watch("hasDiseases") ?? !!request.hasDiseases) ? (
          <Grid item xs={12}>
            ...
            {[
              ...
              "Anemia",
              "Epilepsia",
              "Malesa di kurason i ader",
              "Preshon haltu",
              "Malesa di kueru",
              "Kanser",
              "Malesa di higra",
              "Malesa di stoma i tripa",
              "Malesa di nir",
              "Romatismo",
              "Keho di lomba i nèk",
              "Sikkel sèl",
                    ...
                    render={({ field }) => {
                      return (
                        <Checkbox
                          ...
                          onChange={() =>
                            field.onChange(handleDiseasesSelect(name))
                          }
                        />
                      );
                    }}
            ...
            {errors.diseases && (
              <p style={{ color: "#bf1650" }}>{errors.diseases.message}</p>
            )}
          </Grid>
        ) : null}
        <Grid item xs={12}>
          ...
          {errors.hasMedicalTreatment && (
            <p style={{ color: "#bf1650" }}>
              {errors.hasMedicalTreatment.message}
            </p>
          )}
        </Grid>
        {JSON.parse(
          watch("hasMedicalTreatment") ?? request.hasMedicalTreatment
        ) && (
          <>
            <Grid item xs={12} sm={6}>
              <Typography
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    ...
                    <MenuItem value="generalPractitioner">
                      Dòkter di kas
                    </MenuItem>
            ...
            <Grid item xs={12} sm={6}>
              ...
              />
              {errors.medicalPractitionerName && (
                <p style={{ color: "#bf1650" }}>
                  {errors.medicalPractitionerName.message}
                </p>
              )}
            </Grid>
          </>
        ...
        {["specialist", "psychologist", "psychiatrist"].includes(
          watch("medicalTreatment") ?? request.medicalTreatment
        ) ? (
          <Grid item xs={12} sm={6}>
            <Typography
              variant="subtitle1"
            ...
            <Controller
              ...
              render={({ field }) => (
                <DropzoneArea
                  ...
                  dropzoneText={`Por fabor ‘upload’ e karta di bo ${
                    (watch("medicalTreatment") ?? request.medicalTreatment) ===
                    "specialist"
                      ? "Spesialista médiko"
                      : (watch("medicalTreatment") ??
            ...
            />
            {errors.proofOfMedicalTreatment && (
              <p style={{ color: "#bf1650" }}>
                {errors.proofOfMedicalTreatment.message}
              </p>
            )}
          </Grid>
        ) : null}
        <Grid item xs={12}>
          <Typography
            ...
            className={classes.inputTitle}
          >
            32. Dor di bo limitashon bo ta hasi huzo di? (skohe mas opshon si
            esaki ta e kaso)
          </Typography>
          {[
            "Rolatòr",
            "Ròlstül",
            "Aparato pa oido",
            "Implantashon na e oido",
            "Kachó ku ta kompaña un siegu",
            "Garoti",
            "Otro",
          ].map((name) => (
            <FormControlLabel
                  ...
                  render={({ field }) => {
                    return (
                      <Checkbox
                        ...
                        checked={field.value?.includes(name) || false}
                        onChange={() =>
                          field.onChange(handleEquipmentsSelect(name))
                        }
                      />
                    );
                  }}
          ...
          {errors.equipments && (
            <p style={{ color: "#bf1650" }}>{errors.equipments.message}</p>
          )}
        </Grid>
        <Grid item xs={12}>
          <Typography
            ...
            className={classes.inputTitle}
          >
            33. Kua instansia ta guia bo den esaki? (skohe mas opshon si esaki
            ta e kaso)
          </Typography>
          {[
            "Mgr. Verriet",
                  ...
                  render={({ field }) => {
                    return (
                      <Checkbox
                        ...
                        checked={field.value?.includes(name) || false}
                        onChange={() =>
                          field.onChange(handleTreatmentCentersSelect(name))
                        }
                      />
                    );
                  }}
          ...
          {errors.treatmentCenters && (
            <p style={{ color: "#bf1650" }}>
              {errors.treatmentCenters.message}
            </p>
          )}
        </Grid>
        {(watch("treatmentCenters") ?? request.treatmentCenters).includes(
          "Otro"
        ) && (
          <Grid item xs={12} sm={6}>
            <Typography
            ...
            />
            {errors.otherTreatmentCenter && (
              <p style={{ color: "#bf1650" }}>
                {errors.otherTreatmentCenter.message}
              </p>
            )}
          </Grid>
        )}
        <Grid item xs={12}>
          ...
          />
          {errors.hasPsychologicalLimitation && (
            <p style={{ color: "#bf1650" }}>
              {errors.hasPsychologicalLimitation.message}
            </p>
          )}
        </Grid>
        {JSON.parse(
          watch("hasPsychologicalLimitation") ??
          ...
          <Grid
            ...
            sm={
              JSON.parse(
                watch("hasPsychologicalLimitationTreatment") ??
                  request.hasPsychologicalLimitation
              )
                ? 6
                : false
          ...
          >
            ...
            />
            {errors.hasPsychologicalLimitationTreatment && (
              <p style={{ color: "#bf1650" }}>
                {errors.hasPsychologicalLimitationTreatment.message}
              </p>
            )}
          </Grid>
        )}
        {JSON.parse(
          ...
          <Grid item xs={12} sm={6}>
            ...
            {errors.psychologicalLimitationCenter && (
              <p style={{ color: "#bf1650" }}>
                {errors.psychologicalLimitationCenter.message}
              </p>
            )}
          </Grid>
        ) : null}
        {JSON.parse(
          ...
          <Grid item xs={12}>
            ...
            <Controller
              ...
              render={({ field }) => (
                <RadioGroup
                  {...field}
                  error={
                    errors.hasPsychologicalLimitationTreatment ? true : false
                  }
                >
                  <FormControlLabel
                    value={true}
            ...
            />
            {errors.hasPsychologicalLimitationDiagnostic && (
              <p style={{ color: "#bf1650" }}>
                {errors.hasPsychologicalLimitationDiagnostic.message}
              </p>
            )}
          </Grid>
        ) : null}
        {JSON.parse(
          watch("hasPsychologicalLimitationDiagnostic") ??
          ...
          <>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextField
                    ...
                    fullWidth
                    error={
                      errors.psychologicalLimitationDiagnostician ? true : false
                    }
                  />
                )}
              />
              {errors.psychologicalLimitationDiagnostician && (
                <p style={{ color: "#bf1650" }}>
                  {errors.psychologicalLimitationDiagnostician.message}
                </p>
              )}
            </Grid>
            <Grid item xs={12} sm={6}>
                    ...
                    <DatePicker
                      ...
                      renderInput={(params) => (
                        <TextField
                          ...
                          fullWidth
                          error={
                            errors?.psychologicalLimitationDiagnosticDate
                              ? true
                              : false
                          }
                        />
              ...
              {errors.psychologicalLimitationDiagnosticDate && (
                <p style={{ color: "#bf1650" }}>
                  {errors.psychologicalLimitationDiagnosticDate.message}
                </p>
              )}
            </Grid>
            <Grid
              ...
              sm={
                JSON.parse(
                  watch("hasPsychologicalLimitationDiagnosticReport") ??
            ...
            >
              ...
              <Controller
                ...
                error={
                  errors.hasPsychologicalLimitationDiagnosticReport
                    ? true
                    : false
                }
                render={({ field }) => (
              ...
              {errors.hasPsychologicalLimitationDiagnosticReport && (
                <p style={{ color: "#bf1650" }}>
                  {errors.hasPsychologicalLimitationDiagnosticReport.message}
                </p>
              )}
            </Grid>
            {JSON.parse(
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <DropzoneArea
                      {...field}
                      initialFiles={
                        request.proofOfPsychologicalLimitationDiagnosticReport ||
                        []
                      }
                      dropzoneText="‘Upload’ e karta di diagnóstiko di bo médiko (image/* òf .pdf)"
                      error={
                        errors.proofOfPsychologicalLimitationDiagnosticReport
                          ? true
                          : false
                      }
        ...
        <Grid item xs={12}>
          ...
          />
          {errors.hasMentalDisorder && (
            <p style={{ color: "#bf1650" }}>
              {errors.hasMentalDisorder.message}
            </p>
          )}
        </Grid>
        {JSON.parse(
          watch("hasMentalDisorder") ?? !!request.hasMentalDisorder
        ) && (
          <Grid
            item
            xs={12}
          ...
          >
            ...
            />
            {errors.hasMentalDisorderTreatment && (
              <p style={{ color: "#bf1650" }}>
                {errors.hasMentalDisorderTreatment.message}
              </p>
            )}
          </Grid>
        )}
        {JSON.parse(
          watch("hasMentalDisorderTreatment") ??
          ...
          <Grid item xs={12} sm={6}>
            ...
            />
            {errors.mentalDisorderTreatmentCenter && (
              <p style={{ color: "#bf1650" }}>
                {errors.mentalDisorderTreatmentCenter.message}
              </p>
            )}
          </Grid>
        )}
        {JSON.parse(
          ...
          <Grid item xs={12}>
            ...
            />
            {errors.hasMentalDisorderDiagnostic && (
              <p style={{ color: "#bf1650" }}>
                {errors.hasMentalDisorderDiagnostic.message}
              </p>
            )}
          </Grid>
        ) : null}
        {JSON.parse(
          watch("hasMentalDisorderDiagnostic") ??
          ...
          <>
            <Grid item xs={12} sm={6}>
              ...
              <Controller
                ...
                control={control}
              />
              {errors.mentalDisorderDiagnostician && (
                <p style={{ color: "#bf1650" }}>
                  {errors.mentalDisorderDiagnostician.message}
                </p>
              )}
            </Grid>
            <Grid item xs={12} sm={6}>
                    ...
                    <DatePicker
                      ...
                      renderInput={(params) => (
                        <TextField
                          ...
                          fullWidth
                          error={
                            errors?.mentalDisorderDiagnosticDate ? true : false
                          }
                        />
                      )}
                    />
              ...
              />
              {errors.mentalDisorderDiagnosticDate && (
                <p style={{ color: "#bf1650" }}>
                  {errors.mentalDisorderDiagnosticDate.message}
                </p>
              )}
            </Grid>
            <Grid
              ...
              sm={
                JSON.parse(
                  watch("hasMentalDisorderDiagnosticReport") ??
            ...
            >
              ...
              <Controller
                ...
                error={
                  errors.hasMentalDisorderDiagnosisDateReport ? true : false
                }
                render={({ field }) => (
                  <RadioGroup {...field}>
                    <FormControlLabel
              ...
              />
              {errors.hasMentalDisorderDiagnosticReport && (
                <p style={{ color: "#bf1650" }}>
                  {errors.hasMentalDisorderDiagnosticReport.message}
                </p>
              )}
            </Grid>
            {JSON.parse(
              ...
              <Grid item xs={12} sm={6}>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <DropzoneArea
                      ...
                      dropzoneText="‘Upload’ e karta di diagnóstiko di bo médiko (image/* òf .pdf)"
                      initialFiles={
                        request.proofOfMentalDisorderDiagnosticReport || []
                      }
                      error={
                        errors.proofOfMentalDisorderDiagnosticReport
                          ? true
                          : false
                      }
                ...
                {errors.proofOfMentalDisorderDiagnosticReport && (
                  <p style={{ color: "#bf1650" }}>
                    {errors.proofOfMentalDisorderDiagnosticReport.message}
                  </p>
                )}
              </Grid>
            ) : null}
        ...
        <Grid item xs={12}>
          ...
          />
          {errors.hasPsychologicalLimitationChild && (
            <p style={{ color: "#bf1650" }}>
              {errors.hasPsychologicalLimitationChild.message}
            </p>
          )}
        </Grid>
        <Grid item xs={12} sm={6}>
          ...
          />
          {errors.insurance && (
            <p style={{ color: "#bf1650" }}>{errors.insurance.message}</p>
          )}
        </Grid>
        ...
        <Grid
          ...
          sm={
            JSON.parse(
              watch("useMedicalSupplies") ?? !!request.useMedicalSupplies
            )
              ? 6
              : false
          }
        >
          ...
          />
          {errors.useMedicalSupplies && (
            <p style={{ color: "#bf1650" }}>
              {errors.useMedicalSupplies.message}
            </p>
          )}
        </Grid>
        {JSON.parse(
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Controller
              ...
              control={control}
            />
            {errors.medicalSupplies && (
              <p style={{ color: "#bf1650" }}>
                {errors.medicalSupplies.message}
              </p>
            )}
          </Grid>
        )}
        <Grid
          ...
          xs={12}
          sm={
            JSON.parse(watch("hasWelfare") ?? !!request.hasWelfare) ? 6 : null
          }
        >
          <Typography
            variant="subtitle1"
          ...
          />
          {errors.hasWelfare && (
            <p style={{ color: "#bf1650" }}>{errors.hasWelfare.message}</p>
          )}
        </Grid>
        {JSON.parse(watch("hasWelfare") ?? !!request.hasWelfare) && (
          <>
            <Grid item xs={12} sm={6}>
              ...
              />
              {errors.welfare && (
                <p style={{ color: "#bf1650" }}>{errors.welfare.message}</p>
              )}
            </Grid>
          </>
        )}
        <Grid
          ...
          sm={
            JSON.parse(
              watch("hasFuneralInsurance") ?? !!request.hasFuneralInsurance
            )
              ? 6
              : false
          }
        >
          ...
          />
          {errors.hasFuneralInsurance && (
            <p style={{ color: "#bf1650" }}>
              {errors.hasFuneralInsurance.message}
            </p>
          )}
        </Grid>
        {JSON.parse(
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  <MenuItem value="AON Dutch Caribbean">
                    AON Dutch Caribbean
                  </MenuItem>
                  <MenuItem value="Ennia">Ennia</MenuItem>
                  <MenuItem value="Entiero na Quota">Entiero na Quota</MenuItem>
                  <MenuItem value="Extura Curaçao">Extura Curaçao</MenuItem>
                  <MenuItem value="International Insurance N.V.">
                    International Insurance N.V.
                  </MenuItem>
                  <MenuItem value="Progressive Insurance">
                    Progressive Insurance
                  </MenuItem>
                  <MenuItem value="Seguros Anta">Seguros Anta</MenuItem>
                  <MenuItem value="Guardian Group">Guardian Group</MenuItem>
                  <MenuItem value="Aska Verzekeringen">
                    Aska Verzekeringen
                  </MenuItem>
                  <MenuItem value="Inter-Assure Insurance">
                    Inter-Assure Insurance
                  </MenuItem>
                  <MenuItem value="Nagico Insurances">
                    Nagico Insurances
                  </MenuItem>
                  <MenuItem value="Sagicor Capital Life">
                  ...
                  <MenuItem value="AVM uitvaartverzekeringen">
                    AVM uitvaartverzekeringen
                  </MenuItem>
            ...
            />
            {errors.funeralInsurance && (
              <p style={{ color: "#bf1650" }}>
                {errors.funeralInsurance.message}
              </p>
            )}
          </Grid>
        )}
